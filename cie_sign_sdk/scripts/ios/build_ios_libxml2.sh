...
if [[ -d "$SRC_PREFIX/include/libxml2" ]]; then
  rsync -a --delete "$SRC_PREFIX/include/libxml2/" "$DEST/include/libxml2/"
else
  echo "Warning: libxml2 headers missing" >&2
fi

cp "$SRC_PREFIX/lib/libxml2.a" "$DEST/lib/"
