...
if [[ -d "$SRC_PREFIX/include/podofo" ]]; then
  rsync -a --delete "$SRC_PREFIX/include/podofo/" "$DEST/include/podofo/"
else
  echo "Warning: podofo headers missing" >&2
fi

cp "$SRC_PREFIX/lib/libpodofo.a" "$DEST/lib/"
